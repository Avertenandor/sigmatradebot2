...
class MetricsMonitorService:
    ...
    async def _get_historical_baseline(
        ...
        """
        # Simplified baseline - in production would use actual historical data
        # For now, return reasonable defaults
        return {
            "pending_withdrawals_mean": 15.0,
            "pending_withdrawals_std": 5.0,
            "withdrawal_amount_mean": 5000.0,
            "withdrawal_amount_std": 2000.0,
            "rejection_rate_mean": 2.0,
            "rejection_rate_std": 1.0,
            "deposit_count_mean": 50.0,
            "deposit_count_std": 10.0,
            "level_5_count_mean": 5.0,
            "level_5_count_std": 2.0,
            "system_liabilities_mean": 100000.0,
            "system_liabilities_std": 20000.0,
        }
