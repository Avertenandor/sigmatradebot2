...
Мы рады приветствовать вас в DeFi-проекте 5-го поколения с автоматизированным трейдингом и арбитражем.

🌐 Наш сайт: https://sigmatrade.org/index.html#exchange
...
export const ERROR_MESSAGES = {
  ...
  USER_BANNED: '❌ Ваш аккаунт заблокирован. Обратитесь в поддержку.',
