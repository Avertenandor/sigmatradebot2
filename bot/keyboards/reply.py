...
def main_menu_reply_keyboard(
    ...
    if (
        ...
        if is_admin:
            ...
            logger.info(f"[KEYBOARD] Checking master key button: telegram_id={telegram_id}, type={type(telegram_id)}, equals={telegram_id == 1040687384}")
            if telegram_id == 1040687384:
                ...
                logger.info(f"[KEYBOARD] NOT adding master key button: telegram_id={telegram_id} != 1040687384")
        else:
